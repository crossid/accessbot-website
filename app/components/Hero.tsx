...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      Revolutionize how your workforce requests and receives applications access, with our chatbot orchestrating fine-tuned access recommendations, approvals and provisioning seamlessly.
      </p>
