...
const faqs = [
  [
    ...
    },
    {
      ...
      answer: 'The chatbot seamlessly integrates with current IT systems, including popular directories like Azure and Okta, and works with native messaging apps like Slack and Teams. It’s designed to complement and enhance your existing IT infrastructure.',
    },
  ],
  [
    {
      question: 'Does the chatbot support multiple languages?',
      answer: 'Yes, our chatbot is equipped with multi-language support to cater to a diverse global workforce. It can handle requests and provide assistance in several major languages, making it an accessible and inclusive tool for organizations with international teams.'
    },
    {
      question:
        ' Is the chatbot user-friendly and easy to use for all employees?',
      answer:
